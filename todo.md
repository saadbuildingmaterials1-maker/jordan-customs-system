...
- [ ] إنشاء صفحة عرض البيان الجمركي المتقدمة (AdvancedDeclarationPage)
- [ ] تصميم جدول مطابق تماماً لملف البيان الأصلي
- [ ] إضافة أعمدة: رقم البند، بند التعرفة، الرمز HS، الكمية، السعر
- [ ] إضافة أعمدة: نسبة الرسم، المبلغ، الطرد، العملة
- [ ] عرض معلومات المستورد والشركة والتواريخ
