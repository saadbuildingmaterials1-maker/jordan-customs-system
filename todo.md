...
## المرحلة 44: خاصية استيراد ملفات PDF
- [ ] إنشاء خدمة استخراج البيانات من ملفات PDF (PDF Extraction Service)
- [ ] إضافة واجهة استيراد PDF في صفحة البيان الجمركي
- [ ] تطوير نظام ملء البيانات التلقائي من ملف PDF
- [ ] إضافة التحقق من صحة البيانات المستخرجة
- [ ] معالجة الأخطاء والبيانات الناقصة
- [ ] اختبار شامل لخاصية الاستيراد مع ملفات PDF حقيقية
...
- [ ] إضافة Toast لعملية تحديث بيانات المستورد
- [ ] إضافة Toast لعملية حذف الملفات المرفقة
- [ ] إضافة Toast لعملية تحديث الحسابات
- [x] كتابة اختبارات Vitest للعمليات مع Toast (26 اختبار)
- [ ] اختبار جميع الصفحات والعمليات
...
## المرحلة 36: تطوير تطبيق الهاتف المحمول (React Native)
...
- [ ] بناء نظام مزامنة البيانات
- [ ] بناء نظام الإشعارات على الهاتف
- [ ] بناء ميزة استيراد PDF على الهاتف
- [ ] بناء لوحة تحكم محسّنة للهاتف
- [ ] بناء نظام البحث والتصفية
- [ ] بناء نظام التقارير على الهاتف
- [ ] اختبار شامل للتطبيق
- [ ] بناء ونشر التطبيق على App Store و Google Play


## المرحلة 37: دمج بوابة الدفع Stripe - قيد الإنجاز
...
- [ ] إنشاء إجراءات tRPC لتتبع الحاويات
- [ ] إضافة تنبيهات تلقائية لحالة الشحنة
- [ ] دمج خريطة Google لعرض موقع الشحنة
