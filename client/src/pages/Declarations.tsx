...
function DeclarationsSEO() {
  useEffect(() => {
    // Update page title
    document.title = "إدارة البيانات الجمركية - نظام الجمارك والشحن الأردني";
    ...
    metaDescription.setAttribute('content', 'إدارة شاملة للبيانات الجمركية والرسوم والضرائب والشحنات. نظام متقدم لتتبع البيانات الجمركية والإجراءات الجمركية في الأردن.');
    ...
    metaKeywords.setAttribute('content', 'البيانات الجمركية، الجمارك، الشحن، الرسوم الجمركية، الضرائب، إدارة الشحنات، نظام الجمارك الأردني، التصريحات الجمركية، تتبع الشحنات');
    
    // Structured Data (JSON-LD)
    const structuredData = {
      '@context': 'https://schema.org',
      '@type': 'WebPage',
      'name': 'إدارة البيانات الجمركية',
      'description': 'نظام إدارة شامل للبيانات الجمركية والرسوم والضرائب',
      'url': window.location.href,
      'inLanguage': 'ar',
      'datePublished': new Date().toISOString(),
      'mainEntity': {
        '@type': 'Organization',
        'name': 'نظام إدارة تكاليف الشحن والجمارك الأردنية',
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-900 to-slate-900 text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-8">
          ...
          <h2 className="text-2xl font-bold text-blue-200 mb-6">البحث والتصفية</h2>
          ...
          {/* Declarations Table Section */}
          <h2 className="text-2xl font-bold text-blue-200 mb-6">قائمة البيانات الجمركية</h2>
          ...
          {/* Statistics Section */}
          <h2 className="text-2xl font-bold text-blue-200 mb-6 mt-12">إحصائيات البيانات الجمركية</h2>
