  ...
  const teamMembers = [
    {
      ...
      description: 'قيادة استراتيجية وإدارة المشروع',
      icon: '👔',
    },
    {
      name: 'فاطمة علي',
      role: 'مدير التطوير',
      description: 'تطوير التطبيقات والأنظمة',
      icon: '💻',
    },
    {
      name: 'محمد حسن',
      role: 'مدير العمليات',
      description: 'إدارة العمليات والجودة',
      icon: '⚙️',
    },
    {
      name: 'ليلى إبراهيم',
      role: 'مدير المبيعات',
      description: 'العلاقات مع العملاء والتسويق',
      icon: '📊',
    },
  ];
