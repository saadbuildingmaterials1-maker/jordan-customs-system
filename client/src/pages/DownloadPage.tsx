...
export default function DownloadPage() {
  ...
  const [downloads, setDownloads] = useState<DownloadItem[]>([
    ...
    },
    {
      ...
      size: "851 MB",
      version: "2.5.0",
      description: "تطبيق سطح المكتب لنظام Windows 7 أو أحدث",
      downloadUrl: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663107576035/vUncndeJboXJJixI.zip",
      isDownloading: false,
      progress: 0,
      isCompleted: false,
      error: null,
    },
    {
      ...
      downloadUrl: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663107576035/lSSotacfmkpkwohz.zip",
      isDownloading: false,
      progress: 0,
      isCompleted: false,
      error: null,
    },
    {
      ...
      downloadUrl: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663107576035/wTHBGaLIIGOmdqSF.zip",
      isDownloading: false,
      progress: 0,
      isCompleted: false,
      error: null,
